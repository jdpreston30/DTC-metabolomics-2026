...
TFT_annot <- readr::read_csv(config$data_files$TFT_annot, show_col_types = FALSE)
UFT_full <- readr::read_csv(config$data_files$UFT_full, show_col_types = FALSE)
UFT_filtered <- readr::read_csv(config$data_files$UFT_filtered, show_col_types = FALSE)
