...
fig3 <- ggdraw(xlim = c(0, 8.5), ylim = c(0, 11)) +
  # 3A
  draw_plot(ggdraw() + draw_grob(p3A_combined), x = 0.1866666667, y = 0.6, width = 7.494, height = 9.698) +
  # 3B
  ...
  # 3C
  draw_plot(p3C.R1.C1 , x = 0.533333333, y = 5.319996667, width = 1.5, height = 1.5) +
  draw_plot(p3C.R1.C2,  x = 1.973333332, y = 5.319996667, width = 1.5, height = 1.5) +
  draw_plot(p3C.R1.C3 , x = 3.413333331, y = 5.319996667, width = 1.5, height = 1.5) +
  draw_plot(p3C.R2.C1,  x = 0.533333333, y = 3.886663333, width = 1.5, height = 1.5) +
  draw_plot(p3C.R2.C2 , x = 1.973333332,   y = 3.886663333, width = 1.5, height = 1.5) +
  draw_plot(p3C.R2.C3,  x = 3.413333331,   y = 3.886663333, width = 1.5, height = 1.5) +
  # 3D
  draw_plot(p3D.R1.C1, x = 5.04, y = 5.319996667, width = 1.5, height = 1.5) +
  draw_plot(p3D.R1.C2, x = 6.479999999, y = 5.319996667, width = 1.5, height = 1.5) +
  draw_plot(p3D.R2.C1, x = 5.04, y = 3.886663333, width = 1.5, height = 1.5) +
  draw_plot(p3D.R2.C2, x = 6.479999999, y = 3.886663333, width = 1.5, height = 1.5) +
  # Labels
  figure_labels(list(
    A = c(0.623333333, 10.04667),
    B = c(5.13, 10.04667),
    C = c(0.623333333, 6.963333333),
    D = c(5.13, 6.963333333),
