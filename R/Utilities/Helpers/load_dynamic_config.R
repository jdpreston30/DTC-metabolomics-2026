...
load_dynamic_config <- function(computer = "auto", config_path = "config_dynamic.yaml") {
  ...
  # Create substitution variables - only need to resolve base_data_path
  ...
  # Simple path resolution - only for basic template substitution
  ...
  resolved_config$data_files <- resolve_paths(raw_config$data_files, substitution_vars)
